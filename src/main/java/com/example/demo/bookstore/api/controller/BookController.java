...
public class BookController {
    ...
    public BookInfo create(
            @Valid @RequestBody BookCreateInput input) {
    ...
    public BookInfo createWithCover(
            ...
            @Valid @RequestPart("jsonData") BookCreateInput input)
    {
    ...
    public BookInfo put(@PathVariable("id") Integer id,
                        @Valid @RequestBody BookUpdateInput input){
