...
public class BookUpdateInput {
    ...
    @Length(max = 100, message = "book's author should be limited in 100 characters") @Pattern(regexp = "[0-9a-zA-Z\\s]{1,20}", message = "book's author only allow alphabets and numbers")
    ...
    @Length(max = 100, message = "book's category should be limited in 100 characters") @Pattern(regexp = "[0-9a-zA-Z\\s]{1,10}", message = "book's category only allow alphabets and numbers")
