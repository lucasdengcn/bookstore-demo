...
java -Xmx512m -Dspring.aot.enabled=true -XX:SharedArchiveFile=application.jsa -Dspring.config.additional-location=file:../dynamic-config/biz-config.yaml -jar $RUN_JAR
